...
<body>
    <nav class="navbar nav-tabs lead">
        ...
        <a href="/"><img src="{{ asset('img/laravel-icon.png') }}" width="150" height="80"></a>
        <a class="nav-link" href="#" style="color:deepskyblue;"></a>
        <b class="nav-pills" href="#" style="color:deepskyblue;"><i class="fab fa-laravel"></i>
            Examen U1 <strong>"Laravel 8"</strong></b>


        <ul class="nav nav-pills">
            <li class="nav-item dropdown">
                <a class="nav-link" data-toggle="dropdown" href="#" style="color: rgb(255, 187, 0)"><i
                        class="far fa-images"></i>
                    Vistas</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/jefes" style="color:aqua;"><i class="fas fa-route"></i>
                    Rutas</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/" style="color:hsl(241, 100%, 68%);"><i class="fas fa-biohazard"></i>
                    Controladores</a>
            </li>
            <li class="nav-item">
    ...
    <div class="card text-center  bordeFooter">
        ...
        <div class="card-footer text-muted lead" style="background: #c7d491">
            <img src="{{ asset('img/laravel-icon.png') }}" width="150px" height="80px" alt=""> 2021© Todos los
            derechos reservados
        </div>
    </div>
</body>
